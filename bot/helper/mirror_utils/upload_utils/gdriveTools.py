...
class GoogleDriveHelper:
    ...
    def __upload_empty_file(self, path, file_name, mime_type, parent_id=None):
        ...
        file_metadata = {
            'name': file_name,
            'description': 'tickernelz Projects',
            'mimeType': mime_type,
        }
    ...
    def drive_list(self, fileName):
        ...
        if response["files"]:
            ...
            self.path = []
            msg += f'<h4>Results : {fileName}</h4><br>@tickernelz Projects<br><br>'
            ...
            for content in self.telegraph_content :
                self.path.append(telegra_ph.create_page(title = 'tickernelz Projects',
