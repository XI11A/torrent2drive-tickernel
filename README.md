...
```
git clone https://github.com/tickernelz/torrent2drive-tickernel
cd torrent2drive-tickernel
```
...
```
- Tambah database - [check here](https://github.com/tickernelz/torrent2drive-tickernel#buat-database-di-heroku) (kalau sudah buat abaikan)
